import { AccordionProps } from '../../../ui/Accordion/types/AccordionProps.type';

export const firstSectionProps: AccordionProps = [
  {
  ...
  {
    title: "How do I find out about bank's decision on my application?",
    description:
      'After registration, you will receive an e-mail with a decision on your application.',
  },
];

export const secondSectionProps: AccordionProps = [
  {
